...
function getRulesLevelString(level) {
    // Replaced this for Core Rulebook era
    // Previously:
    //     0 - Undefined
    //     1 - Introductory
    //     2 - Standard
...
const knownWeapons = [
    ...
    },
    {
        ...
        ammoTypes: [
            ...
            {id: "ap", name: "Armor-Piercing (36)"},
            {id: "caseless", name: "Caseless (90)"},
            {id: "flak", name: "Flak (45)"},
            {id: "flechette", name: "Flechette (45)", level: 3},
            {id: "precision", name: "Precision (27)"},
    ...
    },
    {
        ...
        ammoTypes: [
            ...
            {id: "ap", name: "Armor-Piercing (16)"},
            {id: "caseless", name: "Caseless (40)"},
            {id: "flak", name: "Flak (20)"},
            {id: "flechette", name: "Flechette (20)", level: 3},
            {id: "precision", name: "Precision (12)"},
    ...
    },
    {
        ...
        ammoTypes: [
            ...
            {id: "ap", name: "Armor-Piercing (8)"},
            {id: "caseless", name: "Caseless (20)"},
            {id: "flak", name: "Flak (10)"},
            {id: "flechette", name: "Flechette (10)", level: 3},
            {id: "precision", name: "Precision (6)"},
    ...
    },
    {
        ...
        ammoTypes: [
            ...
            {id: "ap", name: "Armor-Piercing (4)"},
            {id: "caseless", name: "Caseless (10)"},
            {id: "flak", name: "Flak (5)"},
            {id: "flechette", name: "Flechette (5)", level: 3},
            {id: "precision", name: "Precision (3)"},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "acid", name: "Acid"},
            {id: "arad", name: "Anti-Radiation", extraBV: 2.4, level: 3},
            {id: "artemisiv", name: "Artemis IV-Equipped", requirement:"artemisiv"},
            {id: "fragmentation", name: "Fragmentation", level: 3},
            {id: "harpoon", name: "Harpoon", level: 3},
            {id: "heatseeking", name: "Heat-Seeking", extraBV: 4, level: 3},
            {id: "inferno", name: "Inferno"},
            {id: "magneticpulse", name: "Magnetic-Pulse", extraBV: 8, level: 3},
            {id: "mineclearance", name: "Mine-Clearance", level: 3},
            {id: "narc", name: "Narc-Equipped"},
            {id: "smoke", name: "Smoke", level: 3},
            {id: "tandem", name: "Tandem-Charge", extraBV: 8, level: 3},
            {id: "teargas", name: "Tear Gas", level: 3},
        ]
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "acid", name: "Acid"},
            {id: "arad", name: "Anti-Radiation", extraBV: 3.6, level: 3},
            {id: "artemisiv", name: "Artemis IV-Equipped", requirement:"artemisiv"},
            {id: "fragmentation", name: "Fragmentation", level: 3},
            {id: "harpoon", name: "Harpoon", level: 3},
            {id: "heatseeking", name: "Heat-Seeking", extraBV: 6, level: 3},
            {id: "inferno", name: "Inferno"},
            {id: "magneticpulse", name: "Magnetic-Pulse", extraBV: 12, level: 3},
            {id: "mineclearance", name: "Mine-Clearance", level: 3},
            {id: "narc", name: "Narc-Equipped"},
            {id: "smoke", name: "Smoke", level: 3},
            {id: "tandem", name: "Tandem-Charge", extraBV: 12, level: 3},
            {id: "teargas", name: "Tear Gas", level: 3},
        ]
    },
    {
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard (24)"},
            {id: "arad", name: "Anti-Radiation (24)", extraBV: 2.1, level: 3},
            {id: "artemisiv", name: "Artemis IV-Equipped (24)", requirement:"artemisiv"},
            {id: "ftl", name: "Follow-the-Leader (12)", extraBV: 3.5, level: 3},
            {id: "fragmentation", name: "Fragmentation (24)", level: 3},
            {id: "heatseeking", name: "Heat-Seeking (12)", extraBV: 3.5, level: 3},
            {id: "incendiary", name: "Incendiary (24)", level: 3},
            {id: "magneticpulse", name: "Magnetic-Pulse (24)", extraBV: 7, level: 3},
            {id: "mineclearance", name: "Mine-Clearance (24)", level: 3},
            {id: "narc", name: "Narc-Equipped (24)"},
            {id: "semiguided", name: "Semi-Guided (24)"},
            {id: "smoke", name: "Smoke (24)", level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard (12)"},
            {id: "arad", name: "Anti-Radiation (12)", extraBV: 3.9, level: 3},
            {id: "artemisiv", name: "Artemis IV-Equipped (12)", requirement:"artemisiv"},
            {id: "ftl", name: "Follow-the-Leader (6)", extraBV: 6.5, level: 3},
            {id: "fragmentation", name: "Fragmentation (12)", level: 3},
            {id: "heatseeking", name: "Heat-Seeking (6)", extraBV: 6.5, level: 3},
            {id: "incendiary", name: "Incendiary (12)", level: 3},
            {id: "magneticpulse", name: "Magnetic-Pulse (12)", extraBV: 13, level: 3},
            {id: "mineclearance", name: "Mine-Clearance (12)", level: 3},
            {id: "narc", name: "Narc-Equipped (12)"},
            {id: "semiguided", name: "Semi-Guided (12)"},
            {id: "smoke", name: "Smoke (12)", level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard (8)"},
            {id: "arad", name: "Anti-Radiation (8)", extraBV: 6, level: 3},
            {id: "artemisiv", name: "Artemis IV-Equipped (8)", requirement:"artemisiv"},
            {id: "ftl", name: "Follow-the-Leader (4)", extraBV: 10, level: 3},
            {id: "fragmentation", name: "Fragmentation (8)", level: 3},
            {id: "heatseeking", name: "Heat-Seeking (4)", extraBV: 10, level: 3},
            {id: "incendiary", name: "Incendiary (8)", level: 3},
            {id: "magneticpulse", name: "Magnetic-Pulse (8)", extraBV: 20, level: 3},
            {id: "mineclearance", name: "Mine-Clearance (8)", level: 3},
            {id: "narc", name: "Narc-Equipped (8)"},
            {id: "semiguided", name: "Semi-Guided (8)"},
            {id: "smoke", name: "Smoke (8)", level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard (6)"},
            {id: "arad", name: "Anti-Radiation (6)", extraBV: 7.8, level: 3},
            {id: "artemisiv", name: "Artemis IV-Equipped (6)", requirement:"artemisiv"},
            {id: "ftl", name: "Follow-the-Leader (3)", extraBV: 13, level: 3},
            {id: "fragmentation", name: "Fragmentation (6)", level: 3},
            {id: "heatseeking", name: "Heat-Seeking (3)", extraBV: 13, level: 3},
            {id: "incendiary", name: "Incendiary (6)", level: 3},
            {id: "magneticpulse", name: "Magnetic-Pulse (6)", extraBV: 26, level: 3},
            {id: "mineclearance", name: "Mine-Clearance (6)", level: 3},
            {id: "narc", name: "Narc-Equipped (6)"},
            {id: "semiguided", name: "Semi-Guided (6)"},
            {id: "smoke", name: "Smoke (6)", level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard (18)"},
            {id: "artemisiv", name: "Artemis IV-Equipped (18)", requirement:"artemisiv"},
        ]
    },
    {
        id: "is:elrm10", 
        ...
        ammoTypes: [
            {id: "standard", name: "Standard (9)"},
            {id: "artemisiv", name: "Artemis IV-Equipped (9)", requirement:"artemisiv"},
        ]
    },
    {
        id: "is:elrm15", 
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard (4)"},
            {id: "artemisiv", name: "Artemis IV-Equipped (4)", requirement:"artemisiv"},
        ]
    },
    {
        id: "is:mechmortar1", 
    ...
    },
    {
        ...
        ammoTypes: [
            ...
            {id: "semiguided", name: "Semi-Guided (4)"},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "lrm", name: "LRM (40)"},
            {id: "lrm-arad", name: "Anti-Radiation LRM (40)", extraBV: 1.2, level: 3},
            {id: "lrm-artemisiv", name: "Artemis IV-Equipped LRM (40)", requirement:"artemisiv"},
            {id: "lrm-ftl", name: "Follow-the-Leader LRM (20)", extraBV: 2, level: 3},
            {id: "lrm-fragmentation", name: "Fragmentation LRM (40)", level: 3},
            {id: "lrm-heatseeking", name: "Heat-Seeking LRM (20)", extraBV: 2, level: 3},
            {id: "lrm-incendiary", name: "Incendiary LRM (40)", level: 3},
            {id: "lrm-magneticpulse", name: "Magnetic-Pulse LRM (40)", extraBV: 4, level: 3},
            {id: "lrm-mineclearance", name: "Mine-Clearance LRM (40)", level: 3},
            {id: "lrm-narc", name: "Narc-Equipped LRM (40)"},
            {id: "lrm-semiguided", name: "Semi-Guided LRM (40)"},
            ...
            {id: "lrm-thunder", name: "Thunder LRM (40)"},
            ...
            {id: "srm", name: "SRM (33)"},
            {id: "srm-acid", name: "Acid SRM (33)"},
            {id: "srm-arad", name: "Anti-Radiation SRM (33)", extraBV: 1.2, level: 3},
            {id: "srm-artemisiv", name: "Artemis IV-Equipped SRM (33)", requirement:"artemisiv"},
            {id: "srm-fragmentation", name: "Fragmentation SRM (33)", level: 3},
            ...
            {id: "srm-magneticpulse", name: "Magnetic-Pulse SRM (33)", extraBV: 4, level: 3},
            ...
            {id: "srm-tandem", name: "Tandem-Charge SRM (16)", extraBV: 4, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "lrm", name: "LRM (24)"},
            {id: "lrm-arad", name: "Anti-Radiation LRM (24)", extraBV: 1.8, level: 3},
            {id: "lrm-artemisiv", name: "Artemis IV-Equipped LRM (24)", requirement:"artemisiv"},
            {id: "lrm-ftl", name: "Follow-the-Leader LRM (12)", extraBV: 3, level: 3},
            {id: "lrm-fragmentation", name: "Fragmentation LRM (24)", level: 3},
            {id: "lrm-heatseeking", name: "Heat-Seeking LRM (12)", extraBV: 3, level: 3},
            {id: "lrm-incendiary", name: "Incendiary LRM (24)", level: 3},
            {id: "lrm-magneticpulse", name: "Magnetic-Pulse LRM (24)", extraBV: 6, level: 3},
            {id: "lrm-mineclearance", name: "Mine-Clearance LRM (24)", level: 3},
            {id: "lrm-narc", name: "Narc-Equipped LRM (24)"},
            {id: "lrm-semiguided", name: "Semi-Guided LRM (24)"},
            ...
            {id: "lrm-thunder", name: "Thunder LRM (24)"},
            ...
            {id: "srm", name: "SRM (20)"},
            {id: "srm-acid", name: "Acid SRM (20)"},
            {id: "srm-arad", name: "Anti-Radiation SRM (20)", extraBV: 1.8, level: 3},
            {id: "srm-artemisiv", name: "Artemis IV-Equipped SRM (20)", requirement:"artemisiv"},
            {id: "srm-fragmentation", name: "Fragmentation SRM (20)", level: 3},
            ...
            {id: "srm-magneticpulse", name: "Magnetic-Pulse SRM (20)", extraBV: 6, level: 3},
            ...
            {id: "srm-tandem", name: "Tandem-Charge SRM (10)", extraBV: 6, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "lrm", name: "LRM (17)"},
            {id: "lrm-arad", name: "Anti-Radiation LRM (17)", extraBV: 2.4, level: 3},
            {id: "lrm-artemisiv", name: "Artemis IV-Equipped LRM (17)", requirement:"artemisiv"},
            {id: "lrm-ftl", name: "Follow-the-Leader LRM (8)", extraBV: 4, level: 3},
            {id: "lrm-fragmentation", name: "Fragmentation LRM (17)", level: 3},
            {id: "lrm-heatseeking", name: "Heat-Seeking LRM (8)", extraBV: 4, level: 3},
            {id: "lrm-incendiary", name: "Incendiary LRM (17)", level: 3},
            {id: "lrm-magneticpulse", name: "Magnetic-Pulse LRM (17)", extraBV: 8, level: 3},
            {id: "lrm-mineclearance", name: "Mine-Clearance LRM (17)", level: 3},
            {id: "lrm-narc", name: "Narc-Equipped LRM (17)"},
            {id: "lrm-semiguided", name: "Semi-Guided LRM (17)"},
            ...
            {id: "lrm-thunder", name: "Thunder LRM (17)"},
            ...
            {id: "srm", name: "SRM (14)"},
            {id: "srm-acid", name: "Acid SRM (14)"},
            {id: "srm-arad", name: "Anti-Radiation SRM (14)", extraBV: 2.4, level: 3},
            {id: "srm-artemisiv", name: "Artemis IV-Equipped SRM (14)", requirement:"artemisiv"},
            {id: "srm-fragmentation", name: "Fragmentation SRM (14)", level: 3},
            ...
            {id: "srm-magneticpulse", name: "Magnetic-Pulse SRM (14)", extraBV: 8, level: 3},
            ...
            {id: "srm-tandem", name: "Tandem-Charge SRM (7)", extraBV: 8, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "lrm", name: "LRM (13)"},
            {id: "lrm-arad", name: "Anti-Radiation LRM (13)", extraBV: 3.3, level: 3},
            {id: "lrm-artemisiv", name: "Artemis IV-Equipped LRM (13)", requirement:"artemisiv"},
            {id: "lrm-ftl", name: "Follow-the-Leader LRM (6)", extraBV: 5.5, level: 3},
            {id: "lrm-fragmentation", name: "Fragmentation LRM (13)", level: 3},
            {id: "lrm-heatseeking", name: "Heat-Seeking LRM (6)", extraBV: 5.5, level: 3},
            {id: "lrm-incendiary", name: "Incendiary LRM (13)", level: 3},
            {id: "lrm-magneticpulse", name: "Magnetic-Pulse LRM (13)", extraBV: 11, level: 3},
            {id: "lrm-mineclearance", name: "Mine-Clearance LRM (13)", level: 3},
            {id: "lrm-narc", name: "Narc-Equipped LRM (13)"},
            {id: "lrm-semiguided", name: "Semi-Guided LRM (13)"},
            ...
            {id: "lrm-thunder", name: "Thunder LRM (13)"},
            ...
            {id: "srm", name: "SRM (11)"},
            {id: "srm-acid", name: "Acid SRM (11)"},
            {id: "srm-arad", name: "Anti-Radiation SRM (11)", extraBV: 3.3, level: 3},
            {id: "srm-artemisiv", name: "Artemis IV-Equipped SRM (11)", requirement:"artemisiv"},
            {id: "srm-fragmentation", name: "Fragmentation SRM (11)", level: 3},
            ...
            {id: "srm-magneticpulse", name: "Magnetic-Pulse SRM (11)", extraBV: 11, level: 3},
            ...
            {id: "srm-tandem", name: "Tandem-Charge SRM (5)", extraBV: 11, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard (4)"},
            {id: "narc", name: "Narc-Equipped (4)"},
            {id: "semiguided", name: "Semi-Guided (4)"},
            {id: "thunder", name: "Thunder (4)"},
        ]
    },
    {
        id: "is:thunderbolt20", 
        ...
        ammoTypes: [
            ...
            {id: "narc", name: "Narc-Equipped (3)"},
            {id: "semiguided", name: "Semi-Guided (3)"},
            {id: "thunder", name: "Thunder (3)"},
        ]
    },
    {
        id: "is:arrowiv", 
        ...
        ammoTypes: [
            {id: "standard", name: "Standard (5)"},
            {id: "airdefense", name: "Air-Defense (5)", level: 3},
            {id: "cluster", name: "Cluster (5)", level: 3},
            {id: "homing", name: "Homing (5)", tagBV: 50},
            {id: "illumination", name: "Illumination (5)", level: 3},
            {id: "inferno", name: "Inferno (5)"},
            {id: "laserinhibiting", name: "Laser-Inhibiting (2)", level: 3},
            {id: "smoke", name: "Smoke (5)"},
            {id: "thunder", name: "Thunder (5)"},
            {id: "thunder-active", name: "Thunder-Active (5)", extraBV: 120, level: 3},
            {id: "thunder-vibra", name: "Thunder-Vibrabomb (5)", extraBV: 100, level: 3},
        ]
    },
    {
    ...
    },
    {
        ...
        ammoTypes: [
            ...
            {id: "ap", name: "Armor-Piercing (32)"},
            {id: "flak", name: "Flak (40)"},
            {id: "flechette", name: "Flechette (40)", level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "ap", name: "Armor-Piercing", shotMultiplier: 0.8},
            {id: "flak", name: "Flak"},
            {id: "flechette", name: "Flechette", level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard (12)"},
            {id: "arad", name: "Anti-Radiation (12)", extraBV: 4.2, level: 3},
            {id: "artemisiv", name: "Artemis IV-Equipped (12)", requirement:"artemisiv"},
            {id: "artemisv", name: "Artemis V-Equipped (12)", requirement:"artemisv"},
            {id: "ftl", name: "Follow-the-Leader (6)", extraBV: 7, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard (8)"},
            {id: "arad", name: "Anti-Radiation (8)", extraBV: 6.3, level: 3},
            {id: "artemisiv", name: "Artemis IV-Equipped (8)", requirement:"artemisiv"},
            {id: "artemisv", name: "Artemis V-Equipped (8)", requirement:"artemisv"},
            {id: "ftl", name: "Follow-the-Leader (4)", extraBV: 10.5, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard (6)"},
            {id: "arad", name: "Anti-Radiation (6)", extraBV: 8.1, level: 3},
            {id: "artemisiv", name: "Artemis IV-Equipped (6)", requirement:"artemisiv"},
            {id: "artemisv", name: "Artemis V-Equipped (6)", requirement:"artemisv"},
            {id: "ftl", name: "Follow-the-Leader (3)", extraBV: 13.5, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.005, level: 3},
            {id: "ftl", name: "Follow-the-Leader", shotMultiplier: 0.5, extraBV: 0.008, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.015, level: 3},
            {id: "ftl", name: "Follow-the-Leader", shotMultiplier: 0.5, extraBV: 0.025, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.0225, level: 3},
            {id: "ftl", name: "Follow-the-Leader", shotMultiplier: 0.5, extraBV: 0.038, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.06, level: 3},
            {id: "ftl", name: "Follow-the-Leader", shotMultiplier: 0.5, extraBV: 0.1, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.0875, level: 3},
            {id: "ftl", name: "Follow-the-Leader", shotMultiplier: 0.5, extraBV: 0.146, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.135, level: 3},
            {id: "ftl", name: "Follow-the-Leader", shotMultiplier: 0.5, extraBV: 0.225, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.175, level: 3},
            {id: "ftl", name: "Follow-the-Leader", shotMultiplier: 0.5, extraBV: 0.292, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.22, level: 3},
            {id: "ftl", name: "Follow-the-Leader", shotMultiplier: 0.5, extraBV: 0.367, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.27, level: 3},
            {id: "ftl", name: "Follow-the-Leader", shotMultiplier: 0.5, extraBV: 0.450, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.35, level: 3},
            {id: "ftl", name: "Follow-the-Leader", shotMultiplier: 0.5, extraBV: 0.583, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.44, level: 3},
            {id: "ftl", name: "Follow-the-Leader", shotMultiplier: 0.5, extraBV: 0.733, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.54, level: 3},
            {id: "ftl", name: "Follow-the-Leader", shotMultiplier: 0.5, extraBV: 0.900, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.617, level: 3},
            {id: "ftl", name: "Follow-the-Leader", shotMultiplier: 0.5, extraBV: 1.029, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.70, level: 3},
            {id: "ftl", name: "Follow-the-Leader", shotMultiplier: 0.5, extraBV: 1.166, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.787, level: 3},
            {id: "ftl", name: "Follow-the-Leader", shotMultiplier: 0.5, extraBV: 1.312, level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.006, level: 3},
            {id: "harpoon", name: "Harpoon", level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.018, level: 3},
            {id: "harpoon", name: "Harpoon", level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.036, level: 3},
            {id: "harpoon", name: "Harpoon", level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.09, level: 3},
            {id: "harpoon", name: "Harpoon", level: 3},
    ...
    },
    {
        ...
        ammoTypes: [
            {id: "standard", name: "Standard"},
            {id: "arad", name: "Anti-Radiation", extraBV: 0.126, level: 3},
            {id: "harpoon", name: "Harpoon", level: 3},
